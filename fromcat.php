...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <hr>
    <h1 class="mt-5 text-danger">ประเภทหนังสือ</h1>    
    <table id="mytable" class="table table-bordered table-striped table-hover table-secondary">
        <thead>
            <th>#</th>
            <th class="bg-info text-white">categoryname</th>
        ...
        <tbody>
            <?php
                ...
                $fetchcatdata = new DB_cat();
                $sql = $fetchcatdata->fetchcatdata();
              ...
              ?>
                    ...
                    <tr>
                        ...
                        <td><a href="updatecat.php?category_id=<?php echo $row['category_id']; ?>" class="btn btn-primary">Edit</a></td>
                        <td><a href="deletecat.php?category_id=<?php echo $row['category_id']; ?>" class="btn btn-danger">Delete</a></td>
                    </tr>
